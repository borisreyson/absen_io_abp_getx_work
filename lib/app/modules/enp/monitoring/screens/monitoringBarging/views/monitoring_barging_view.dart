...
class MonitoringBargingView extends GetView<MonitoringBargingController> {
  const MonitoringBargingView({Key? key}) : super(key: key);
  ...
  Widget listBarging() {
    return SmartRefresher(
      ...
      child: ListView(
        children:
            controller.dataBarging.map((element) => contentBarging(element)).toList(),
      ),
    );
  }

  Widget contentBarging(DataBarging h) {
    ...
    return Card(
      ...
      child: InkWell(
          onTap: () {
            ...
            controller.dataBarging.clear();
            controller.fetchBarging(
