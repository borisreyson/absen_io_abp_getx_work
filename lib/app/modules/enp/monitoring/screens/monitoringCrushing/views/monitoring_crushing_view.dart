...
class MonitoringCrushingView extends GetView<MonitoringCrushingController> {
  const MonitoringCrushingView({Key? key}) : super(key: key);
  ...
  Widget listCrushing() {
    return SmartRefresher(
      ...
      child: ListView(
        children:
            controller.dataCrushing.map((element) => contentCrushing(element)).toList(),
      ),
    );
  }

  Widget contentCrushing(DataCrushing h) {
    ...
    return Card(
      ...
      child: InkWell(
          onTap: () {
            ...
            controller.dataCrushing.clear();
            controller.fetchCrushing(
