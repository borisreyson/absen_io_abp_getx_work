...
class SarprasKabagView extends GetView<SarprasKabagController> {
  const SarprasKabagView({Key? key}) : super(key: key);
  @override
  ...
  Widget cardSarpras(Data e) {
    ...
    var selisih = start.difference(dbTime);
    var selisihHari = now.difference(dbTime);
    var sisa = 0.obs;
    var detik = 0.obs;
    sisa.value = selisih.inMinutes;

    print("hari ${e.nomor} ${selisihHari.inDays}");
