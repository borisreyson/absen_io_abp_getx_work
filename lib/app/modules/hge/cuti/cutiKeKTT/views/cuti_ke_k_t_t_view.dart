...
class CutiKeKTTView extends GetView<CutiKeKTTController> {
  const CutiKeKTTView({Key? key}) : super(key: key);
  @override
    ...
    return Obx(
      () => Scaffold(
        appBar: AppBar(
          ...
          title: const Text('Pengajuan Cuti Ke KTT'),
          centerTitle: true,
        ),
        ...
        if (e.userBatalVerifikasi == null)
          if (e.atasanVerifikasi != null)
            if (e.deptHeadVerifikasi != null)
              if (e.kttVerifikasi == null) kttVerifikasi(e),
      ],
    );
  }
  ...
  TableRow kttVerifikasi(Data e) {
    return TableRow(children: [
      Card(
        ...
        child: InkWell(
          onTap: () {
            controller.setujuiKTT(e.idCutiOnline);
          },
          child: const Padding(
            padding: EdgeInsets.all(5),
            child: Center(
      ...
      Card(
        ...
        child: InkWell(
          onTap: () {
            controller.batalkanKTT(e.idCutiOnline);
          },
          child: const Padding(
            padding: EdgeInsets.all(5),
            child: Center(
