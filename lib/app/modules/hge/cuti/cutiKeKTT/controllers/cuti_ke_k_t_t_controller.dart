...
class CutiKeKTTController extends GetxController {
  ...
  void onInit() async {
    ...
    dataCuti.clear();
    page.value = 1;
    getKTTCuti(page.value);
    super.onInit();
  }

  getKTTCuti(hal) async {
    await provider.getCutiKTT(page: hal).then((value) {
  ...
  void setujuiKTT(idCutiOnline) async {
    ...
    if (res != null) {
      if (res) {
        ...
        await provider
            .setujuiKTT("${username.value}", idCutiOnline)
            .then((value) {
  ...
  void batalkanKTT(idCutiOnline) async {
