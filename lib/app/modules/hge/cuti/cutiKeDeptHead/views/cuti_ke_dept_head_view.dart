...
class CutiKeDeptHeadView extends GetView<CutiKeDeptHeadController> {
  const CutiKeDeptHeadView({Key? key}) : super(key: key);
  @override
    ...
    return Obx(
      () => Scaffold(
        appBar: AppBar(
          ...
          title: const Text('Pengajuan Cuti Ke Dept Head'),
          centerTitle: true,
        ),
                      ...
                      : (e.atasanVerifikasi != null)
                          ? (e.deptHeadVerifikasi != null)
                              ? (e.kttVerifikasi != null)
                                  ...
                                  : belumDisetujui(e,
                                      "KTT / Mine Manager ${e.deptHeadVerifikasi}")
      ...
      children: [
        ...
        if (e.userBatalVerifikasi == null)
          if (e.atasanVerifikasi != null)
            if (e.deptHeadVerifikasi == null) deptHeadVerifikasi(e),
      ],
    );
  }
  ...
  TableRow deptHeadVerifikasi(Data e) {
    return TableRow(children: [
      Card(
        ...
        child: InkWell(
          onTap: () {
            controller.setujuiDeptHead(e.idCutiOnline);
          },
          child: const Padding(
            padding: EdgeInsets.all(5),
            child: Center(
      ...
      Card(
        ...
        child: InkWell(
          onTap: () {
            controller.batalkanDeptHead(e.idCutiOnline);
          },
          child: const Padding(
            padding: EdgeInsets.all(5),
            child: Center(
