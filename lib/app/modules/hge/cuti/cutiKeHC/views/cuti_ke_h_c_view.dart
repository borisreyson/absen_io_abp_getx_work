...
class CutiKeHCView extends GetView<CutiKeHCController> {
  const CutiKeHCView({Key? key}) : super(key: key);
  @override
    ...
    return Obx(
      () => Scaffold(
        appBar: AppBar(
          ...
          title: const Text('Pengajuan Cuti Ke HC'),
          centerTitle: true,
        ),
          ...
          if (e.atasanVerifikasi != null)
            if (e.deptHeadVerifikasi != null)
              if (e.kttVerifikasi != null)
                if (e.hcVerifikasi == null) hcVerifikasi(e),
      ],
    );
  }
  ...
  TableRow hcVerifikasi(Data e) {
    return TableRow(children: [
      Card(
        ...
        child: InkWell(
          onTap: () {
            controller.setujuiHC(e.idCutiOnline);
          },
          child: const Padding(
            padding: EdgeInsets.all(5),
            child: Center(
      ...
      Card(
        ...
        child: InkWell(
          onTap: () {
            controller.batalkanHC(e.idCutiOnline);
          },
          child: const Padding(
            padding: EdgeInsets.all(5),
            child: Center(
