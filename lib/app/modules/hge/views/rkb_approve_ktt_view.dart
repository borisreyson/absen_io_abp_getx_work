...
import '../../../data/models/approve_models.dart';
import '../../../data/models/rkb_models.dart';
import '../../../data/providers/provider.dart';
import '../../../data/utils/constants.dart';
import '../../../routes/app_pages.dart';
import '../rkbsystem/rkb_ktt/controllers/rkb_ktt_controller.dart';

// ignore: must_be_immutable
class RkbApproveKttView extends GetView {
  final Data data;
  String username;
  String section;
  RkbApproveKttView(
      ...
      : super(key: key);
  @override
  final controller = Get.find<RkbKttController>();
  @override
  ...
  approve(username, noRkb) async {
    ...
    if (doApprove) {
      ...
      await provider.approveRkbKTT(body).then((value) {
        if (value.approve!) {
          Get.back();
