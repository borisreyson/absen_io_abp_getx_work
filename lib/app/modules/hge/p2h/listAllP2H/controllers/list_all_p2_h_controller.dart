...
class ListAllP2HController extends GetxController {
  ...
  final userIn = RxnString(null);
  @override
  void onInit() async {
    var pref = await SharedPreferences.getInstance();
    userIn.value = pref.getString(Constants.username);
    page.value = 1;
    lastPage.value = 1;
    dataP2h.clear();
    ...
    if (argumen != null) {
      ...
      if (res != null) {
        header.Data e = res;
        getP2hSaranaId(page.value, "${e.saranaId}", userIn.value);
      } else {
        getP2hSarana(page.value, userIn.value);
      }
    } else {
      getP2hSarana(page.value, userIn.value);
    }
  ...
  getP2hSarana(hal, userIn) async {
    await provider.getAllP2hSarana(hal, userIn).then((value) {
  ...
  getP2hSaranaId(hal, saranaId, userIn) async {
    await provider.getAllP2hSaranaId(hal, saranaId, userIn).then((value) {
      var resultSarana = value.p2hSarana;
      if (resultSarana != null) {
        lastPage.value = resultSarana.lastPage!;
        dataP2h.addAll(resultSarana.data!);
